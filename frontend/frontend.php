...
class VI_WP_LUCKY_WHEEL_Frontend_Frontend {
                                                ...
                                                <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td colspan="2" valign="middle" id="credit" style="border:0;
															...
															<?php echo wp_kses_post( wpautop( wptexturize( isset( $email_temp['footer_text'] ) ? $email_temp['footer_text'] : '' ) ) ); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
	...
	public function frontend_enqueue() {
		...
		if ( $this->is_mobile ) {
			wp_enqueue_script( 'wp-lucky-wheel-frontend-javascript', VI_WP_LUCKY_WHEEL_JS . 'wp-lucky-wheel-mobile.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
		} else {
			wp_enqueue_script( 'wp-lucky-wheel-frontend-javascript', VI_WP_LUCKY_WHEEL_JS . 'wp-lucky-wheel.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
		}
		$font = '';
