...
class VI_WP_LUCKY_WHEEL_Admin_Admin {
	...
	public function preview_emails_button( $editor_id ) {
		global $pagenow;
		if ( $pagenow == 'admin.php' && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'wp-lucky-wheel' ) {// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	...
	public function preview_emails_ajax() {
		...
		$email_heading = isset( $_GET['heading'] ) ? sanitize_text_field( stripslashes( $_GET['heading'] ) ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$bg            = isset( $_GET['email_background_color'] ) ? sanitize_hex_color( $_GET['email_background_color'] ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$body          = isset( $_GET['email_body_background_color'] ) ? sanitize_hex_color( $_GET['email_body_background_color'] ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$base          = isset( $_GET['email_base_color'] ) ? sanitize_hex_color( $_GET['email_base_color'] ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$text          = isset( $_GET['email_body_text_color'] ) ? sanitize_hex_color( $_GET['email_body_text_color'] ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$img           = isset( $_GET['header_image'] ) ? sanitize_url( $_GET['header_image'] ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$footer_text   = isset( $_GET['footer_text'] ) ? wpautop( wp_kses_post( wptexturize( $_GET['footer_text'] ) ) ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
                ...
                <tr>
                    <td align="center" valign="top">
                        <div id="template_header_image">
							<?php
							if ( $img ) {
								echo '<p style="margin-top:0;"><img src="' . esc_url( $img ) . '" alt="' . wp_kses_post(get_bloginfo( 'name', 'display' )) . '" /></p>';
							}
							?>
                        </div>
	...
	public function admin_enqueue_scripts() {
		...
		if ( $pagenow == 'admin.php' && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'wp-lucky-wheel' ) {// phpcs:ignore WordPress.Security.NonceVerification.Recommended
			...
			wp_enqueue_script( 'wp-lucky-wheel-fontselect-js', VI_WP_LUCKY_WHEEL_JS . 'jquery.fontselect.min.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'wp-lucky-wheel-fontselect-css', VI_WP_LUCKY_WHEEL_CSS . 'fontselect-default.css', '', VI_WP_LUCKY_WHEEL_VERSION );

			wp_enqueue_script( 'wp-lucky-wheel-semantic-js-form', VI_WP_LUCKY_WHEEL_JS . 'form.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-form', VI_WP_LUCKY_WHEEL_CSS . 'form.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-icon', VI_WP_LUCKY_WHEEL_CSS . 'icon.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'wp-lucky-wheel-semantic-js-transition', VI_WP_LUCKY_WHEEL_JS . 'transition.min.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-transition', VI_WP_LUCKY_WHEEL_CSS . 'transition.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'wp-lucky-wheel-semantic-js-dropdown', VI_WP_LUCKY_WHEEL_JS . 'dropdown.min.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-dropdown', VI_WP_LUCKY_WHEEL_CSS . 'dropdown.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'wp-lucky-wheel-semantic-js-checkbox', VI_WP_LUCKY_WHEEL_JS . 'checkbox.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-checkbox', VI_WP_LUCKY_WHEEL_CSS . 'checkbox.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'wp-lucky-wheel-select2-js', VI_WP_LUCKY_WHEEL_JS . 'select2.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'wp-lucky-wheel-select2-css', VI_WP_LUCKY_WHEEL_CSS . 'select2.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'wp-lucky-wheel-semantic-js-tab', VI_WP_LUCKY_WHEEL_JS . 'tab.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-tab', VI_WP_LUCKY_WHEEL_CSS . 'tab.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-input', VI_WP_LUCKY_WHEEL_CSS . 'button.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-table', VI_WP_LUCKY_WHEEL_CSS . 'table.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-segment', VI_WP_LUCKY_WHEEL_CSS . 'segment.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-label', VI_WP_LUCKY_WHEEL_CSS . 'label.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'wp-lucky-wheel-semantic-css-menu', VI_WP_LUCKY_WHEEL_CSS . 'menu.min.css', '', VI_WP_LUCKY_WHEEL_VERSION );
			...
			wp_enqueue_script( 'wp-lucky-wheel-jquery-address-javascript', VI_WP_LUCKY_WHEEL_JS . 'jquery.address-1.6.min.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_script( 'wp-lucky-wheel-admin-javascript', VI_WP_LUCKY_WHEEL_JS . 'admin-javascript.js', array( 'jquery' ), VI_WP_LUCKY_WHEEL_VERSION, true );
			wp_localize_script( 'wp-lucky-wheel-admin-javascript', 'wp_lucky_wheel_params_admin', array(
				'url'               => admin_url( 'admin-ajax.php' ),
				'wplwl_admin_nonce' => wp_create_nonce( 'wplwl_admin_nonce' )
			) );
			wp_enqueue_style( 'wp-lucky-wheel-admin-style', VI_WP_LUCKY_WHEEL_CSS . 'admin-style.css', array(), VI_WP_LUCKY_WHEEL_VERSION );
		}
		wp_enqueue_style( 'wp-lucky-wheel-admin-icon-style', VI_WP_LUCKY_WHEEL_CSS . 'admin-icon-style.css', '', VI_WP_LUCKY_WHEEL_VERSION );
	}
            ...
            <form action="" method="POST" class="vi-ui form">
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="popup">
                    <table class="form-table">
                        ...
                        <tr>
                            <th>
                                <label for="wheel_popup_icon_color"><?php esc_html_e( 'Custom popup icon color', 'wp-lucky-wheel' ); ?></label>
                            </th>
                            <td colspan="2">
                                <a class="vi-ui button" target="_blank"
                                   href="https://1.envato.market/xDRb1"><?php esc_html_e( 'Upgrade This Feature', 'wp-lucky-wheel' ) ?></a>
                        ...
                        <tr>
                            <th>
                                <label for="wheel_popup_icon_bg_color"><?php esc_html_e( 'Custom popup icon background color', 'wp-lucky-wheel' ); ?></label>
                            </th>
                            <td colspan="2">
                                <a class="vi-ui button" target="_blank"
                                   href="https://1.envato.market/xDRb1"><?php esc_html_e( 'Upgrade This Feature', 'wp-lucky-wheel' ) ?></a>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <input type="text" id="show_wheel" name="show_wheel"
                                       value="<?php echo esc_attr( $this->settings->get_params( 'notify', 'show_wheel' ) ); ?>"><?php esc_html_e( 'Enter min,max to set random between min and max (seconds).', 'wp-lucky-wheel' ); ?>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td colspan="2">
                                <input type="text" name="notify_conditional_tags"
                                       ...
                                       value="<?php if ( $this->settings->get_params( 'notify', 'conditional_tags' ) ) {
									       echo wp_kses_post( htmlentities( $this->settings->get_params( 'notify', 'conditional_tags' ) ));
								       } ?>">
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="wheel">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="wheel_speed" id="wheel_speed" class="vi-ui fluid dropdown">
									...
									for ( $i = 1; $i <= 10; $i ++ ) {
										?>
                                        <option value="<?php esc_attr( $i ) ?>" <?php selected( $this->settings->get_params( 'wheel', 'wheel_speed' ), $i ) ?>><?php echo esc_html( $i ); ?></option>
										<?php
									}
									?>
                                </select>
                    ...
                    <table class="form-table wheel-settings" style="margin-top: 0;">
                        ...
                        <tr class="wheel-slices" style="background-color: #000000;">
                            <td width="40"><?php esc_html_e( 'Index', 'wp-lucky-wheel' ) ?></td>
                            <td><?php esc_html_e( 'Prize Type', 'wp-lucky-wheel' ) ?></td>
                            <td><?php esc_html_e( 'Label', 'wp-lucky-wheel' ) ?></td>
                            <td><?php esc_html_e( 'Value', 'wp-lucky-wheel' ) ?></td>
                            <td><?php esc_html_e( 'Probability(%)', 'wp-lucky-wheel' ) ?></td>
                            <td><?php esc_html_e( 'Color', 'wp-lucky-wheel' ) ?></td>
                            <td><?php esc_html_e( 'Text Color', 'wp-lucky-wheel' ) ?></td>
                        </tr>
                        </tbody>
                            ...
                            <tr class="wheel_col">
                                ...
                                <td class="wheel_col_coupons">
                                    <select name="prize_type[]" class="coupons_select vi-ui fluid dropdown">
                                        <option value="non" <?php selected( $this->settings->get_params( 'wheel', 'prize_type' )[ $count ], 'non' ); ?>><?php esc_html_e( 'Non', 'wp-lucky-wheel' ) ?></option>
                                        <option value="custom" <?php selected( $this->settings->get_params( 'wheel', 'prize_type' )[ $count ], 'custom' ); ?>><?php esc_html_e( 'Custom', 'wp-lucky-wheel' ) ?></option>
                                    </select>
                                </td>
                                <td class="wheel_col_coupons_value">
                                    <input type="text" name="custom_type_label[]"
										<?php
										echo ' class="custom_type_label" value="' . wp_kses_post( isset( $this->settings->get_params( 'wheel', 'custom_label' )[ $count ] ) ? $this->settings->get_params( 'wheel', 'custom_label' )[ $count ] : '' ) . '"';
										?> placeholder="Label"/>
                                </td>
                                <td class="wheel_col_coupons_value">
                                ...
                                <td class="wheel_col_probability">
                                    <input type="number" name="probability[]"
                                           ...
                                           value="<?php echo esc_attr( absint( $this->settings->get_params( 'wheel', 'probability' )[ $count ] ) ) ?>"/>
                                </td>
                                <td>
                                ...
                                <td class="remove_field_wrap">
                                    <input type="text" id="slices_text_color" name="slices_text_color[]"
                                           class="color-picker"
                                           value=" <?php echo esc_attr( trim( $this->settings->get_params( 'wheel', 'slices_text_color' )[ $count ] ) ); ?>"
                                           style="background: <?php echo esc_attr( trim( $this->settings->get_params( 'wheel', 'slices_text_color' )[ $count ] ) ); ?>"/>
                        ...
                        <tr>
                            <td class="col_add_new" colspan="3">
                                <i><?php esc_html_e( 'Slices positions are sortable by drag and drop.', 'wp-lucky-wheel' ); ?></i>
                            </td>
                            ...
                            <td class="col_add_new">
								...
								?>
                                <p>
                                    <span class="auto_color positive vi-ui button"><?php esc_html_e( 'Auto Color', 'wp-lucky-wheel' ) ?></span>
                                </p>
                                <div class="vi-ui toggle checkbox">
                                    <p>
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="from_name" type="text" name="from_name"
                                       value="<?php echo isset( $this->settings->get_params( 'result', 'email' )['from_name'] ) ? esc_attr( htmlentities( $this->settings->get_params( 'result', 'email' )['from_name'] ) ) : ''; ?>">
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="from_address" type="text" name="from_address"
                                       value="<?php echo isset( $this->settings->get_params( 'result', 'email' )['from_address'] ) ? esc_attr( htmlentities( $this->settings->get_params( 'result', 'email' )['from_address'] ) ) : ''; ?>">
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="vi-ui button" target="_blank"
                                   href="https://1.envato.market/xDRb1"><?php esc_html_e( 'Upgrade This Feature', 'wp-lucky-wheel' ) ?></a>
                                <p class="description"><?php esc_html_e( 'Send admin notification when someone wins a prize', 'wp-lucky-wheel' ) ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th>
  ...
  "bluegrey": {
    ...
    "600": "#546e7a"
		...
		foreach ( $color_array as $colors ) {
			...
			$i = 0;
			foreach ( $colors as $color ) {
				echo '<div class="wplwl_color_palette" data-color_code="' . esc_attr($color) . '" style="width: 20px;height: 20px;float:left;border:1px solid #ffffff;background-color: ' . esc_attr($color) . ';';
